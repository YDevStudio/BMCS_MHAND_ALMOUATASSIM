...
let PoliceVehicle = (() => {
    ...
    var PoliceVehicle = _classThis = class {
        constructor() {
            this.police_vehicle_name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _police_vehicle_name_initializers, void 0));
        }
    };
    __setFunctionName(_classThis, "PoliceVehicle");
    (() => {
        ...
        PoliceVehicle = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PoliceVehicle = _classThis;
})();
exports.PoliceVehicle = PoliceVehicle;
