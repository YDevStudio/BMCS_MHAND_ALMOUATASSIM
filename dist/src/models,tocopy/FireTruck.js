...
let FireTruck = (() => {
    ...
    var FireTruck = _classThis = class {
        constructor() {
            this.fire_truck_name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _fire_truck_name_initializers, void 0));
        }
    };
    __setFunctionName(_classThis, "FireTruck");
    (() => {
        ...
        FireTruck = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FireTruck = _classThis;
})();
