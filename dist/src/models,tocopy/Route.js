...
let Route = (() => {
    ...
    var Route = _classThis = class {
        constructor() {
            this.route_name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _route_name_initializers, void 0));
        }
    };
    __setFunctionName(_classThis, "Route");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _route_name_decorators = [(0, typeorm_1.PrimaryColumn)()];
