...
const logStatePoliceVehicleNumber = (context, event) => {
...
const logExitFromRouteForFireTrucksDevelopment = (context, event) => {
    console.log("Exiting RouteForFireTrucksDevelopment state");
    // Additional logic for exiting RouteForFireTrucksDevelopment state
};
const logEntryToRouteForFireTrucksToBeProposed = (context, event) => {
...
const logExitFromRouteForFireTrucksToBeProposed = (context, event) => {
...
const logExitFromRouteForPoliceVehiclesDevelopment = (context, event) => {
...
const logEntryToRouteForPoliceVehiclesToBeProposed = (context, event) => {
...
const logExitFromRouteForPoliceVehiclesToBeProposed = (context, event) => {
...
const logExitFromRouteForPoliceVehiclesApproved = (context, event) => {
...
const service = (0, xstate_1.interpret)(exports.crisisManagementMachine).onTransition((state) => console.log(state.value));
service.start();
